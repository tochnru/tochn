...
<body>
   ...
   <main class="main-menu-article container">
      <div class="public-menu-article">
         <div class="img-public img-public--ehto-kak"></div>
         <a href="" class="card-public">
            ...
            <p class="card-public__description card-public__description--color">Один из наиболее простых способов определения центра окружности.</p>
         </a>
      </div>
   </main>
