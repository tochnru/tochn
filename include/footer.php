<footer class="footer" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
   ...
   <meta itemprop="copyrightHolder" content="точно">
   <div class="container">
      ...
      <div class="footer-menu">
         <nav class="footer-nav" itemscope="" itemtype="http://schema.org/SiteNavigationElement">
            <ul class="footer-list">
               <li class="footer-menu__item">
                  <a class="footer-menu__link" href="/kak-reshit/page" itemprop="url">Как решить</a>
               </li>
               <li class="footer-menu__item">
                  <a class="footer-menu__link" href="/ehto-kak/page" itemprop="url">Это как</a>
               </li>
               <li class="footer-menu__item">
         ...
         <div class="footer-copyright">© Точно, 2023</div>
      </div>
   </div>
</footer>